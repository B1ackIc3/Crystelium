...
namespace Cysteel
{
	...
	// several effects and items in Cysteel. See SimpleModPlayer for a very simple example of how ModPlayer classes work.
	public class CysteelPlayer : ModPlayer
	{
		public bool sInferno;
		...
		//	GetInstance<Cysteel>().ExampleUI.ExampleButton.HoverText = "SendClientChanges Example: Non-Stop Party " + (nonStopParty ? "On" : "Off");
		//}
		...
		//	packet.Write((byte)CysteelMessageType.ExamplePlayerSyncPlayer);
		...
		//		packet.Write((byte)CysteelMessageType.NonStopPartyChanged);
		//		packet.Write((byte)player.whoAmI);
		...
		//	// nonStopParty was added after the initial Cysteel release. Read https://github.com/tModLoader/tModLoader/wiki/Saving-and-loading-using-TagCompound#mod-version-updates for information about how to handle version updates in your mod without messing up current users of your mod.
		...
		//	player.ManageSpecialBiomeVisuals("Cysteel:PuritySpirit", usePurity);
		//	bool useVoidMonolith = voidMonolith && !usePurity && !NPC.AnyNPCs(NPCID.MoonLordCore);
		//	player.ManageSpecialBiomeVisuals("Cysteel:MonolithVoid", useVoidMonolith, player.Center);
		//}
		...
		//{
		//	if (Cysteel.RandomBuffHotKey.JustPressed)
		//	{
		...
		//		{
		//			ModPacket packet = mod.GetPacket();
		//			packet.Write((byte)CysteelMessageType.HeroLives);
		...
		//public static readonly PlayerLayer MiscEffectsBack = new PlayerLayer("Cysteel", "MiscEffectsBack", PlayerLayer.MiscEffectsBack, delegate (PlayerDrawInfo drawInfo) {
		//	if (drawInfo.shadow != 0f)
		//	{
		//		return;
		//	}
		//	Player drawPlayer = drawInfo.drawPlayer;
		//	Mod mod = ModLoader.GetMod("Cysteel");
		...
		//	}
		//});
		//public static readonly PlayerLayer MiscEffects = new PlayerLayer("Cysteel", "MiscEffects", PlayerLayer.MiscEffectsFront, delegate (PlayerDrawInfo drawInfo) {
		//	if (drawInfo.shadow != 0f)
		//	{
		//		return;
		//	}
