	...
	public class ExampleGlobalNPC : GlobalNPC
	{
		...
		public override void DrawEffects(NPC npc, ref Color drawColor)
		{
			if (sInferno)
			{
				...
				{
					int dust = Dust.NewDust(npc.position - new Vector2(2f, 2f), npc.width + 4, npc.height + 4, DustType<SinglaicInfernoD>(), npc.velocity.X * 0.4f, npc.velocity.Y * 0.4f, 100, default(Color), 3.5f);
		...
		//		shop.item[nextSlot].shopSpecialCurrency = Cysteel.FaceCustomCurrencyId;
		//		nextSlot++;
		//	}
